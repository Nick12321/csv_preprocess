...
if platform == "linux" or platform == "linux2":
    np.savetxt(r"~/Documents/dev/csv_preprocess/to_downtown_condo/processed/data_processedv4.csv", modified_data_array, delimiter=",", fmt="%d")
elif platform == "win32":
    np.savetxt(r"C:\Users\nick\Documents\dev\csv_preprocess\to_downtown_condo\processed\data_processedv4a.csv", modified_data_array, delimiter=",", fmt="%d")
